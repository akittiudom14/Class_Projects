...
Name: Anthony Kittiudom, Song King 
"""
...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if not insect.is_ant():
            ...
            if (type(insect) == QueenAnt and insect.counter > 1) or type(insect) != QueenAnt:
                self.ant = None
        insect.place = None
...
class Ant(Insect):
    ...
    def can_contain(self, other): # 8
        if self.container is True and self.other.container is False and self.ant is None:
            return True
        else:
            return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place is not hive:
            ...
            if bee != None and distance in range(self.min_range, self.max_range+1):                         #if a bee is found
                return bee
            distance += 1
            place = place.entrance                  #move onto next place
        return None
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, colony):
        ...
        if self.counter > 1:
            ...
            while place.ant is not None:
                if place.ant not in QueenAnt.ant_list:
                    QueenAnt.ant_list.append(place.ant)
                    place.ant.damage *= 2
                place = place.exit
...
class QueenPlace(object):
    ...
    def __init__(self, colony, place):
        Ant.__init__(self,0)
        self.colony = colony
        self.place = place
    ...
    @property
    def bees(self):
        return self.colony.bees + self.place.bees
